  ...
  return (
    <div className="w-full bg-red-100  p-2 rounded-md drop-shadow shadow-lg">
      ...
      <div className="flex justify-center mb-4">
        <button
          onClick={showToast}
          className="border bg-slate-50 shadow-md shadow-pink-300 justify-center px-2 py-2 inline-block text-xs text-pink-500 mt-4 bg-transparent rounded-md hover:bg-purple-100 "
        >
          {" "}
          Activity Completed
        </button>
